...
**Scope note:** FR29 (pushing live event updates to connected clients within a target latency) is section 4.6, not 4.5, and wasn't part of this task's concrete ask — it's a substantial, separate realtime/websocket infrastructure piece, not a natural extension of these REST endpoints. Not built here.
